/*4. El paquete de inquirer es muy util para crear menus interactivos muy buenos */
const inquirer = require('inquirer');
require('colors');

/*5. Para las opciones que tendra el menu se tiene que hacer un menu con la estructura que se ve a continuacion,
...
const inquirerMenu = async() => {
    ...
    /*6. Para mostrar el menu se llama al metodo promt al cual se le pasa el objeto con la estrucutra del menu\
...
const pausa = async() => {
    ...
    //7. Hay diferentes tipos en inquirer, el tipo input es para solo una entrada
    const question = [
        {
            type: 'input',
            name: 'enter',
...
const leerInput = async( message ) => {
    ...
    /*8. Tambien se pueden colcoar validaciones a lo que ingrese el usuario con la propiedad validate - guardarArcihvo.js
